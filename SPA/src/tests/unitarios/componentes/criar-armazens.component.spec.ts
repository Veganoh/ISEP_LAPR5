...
describe('CriarArmazensComponente', () => {
    ...
    let service = jasmine.createSpyObj('CriarArmazensServico', ['criarArmazem']);;
    ...
    it('deve conseguir criar um armazem com sucesso', () => {
        ...
        service.criarArmazem.and.returnValue(of(armazemDto));
    ...
    it('se não houver resposta não deve atualizar', () => {
        ...
        service.criarArmazem.and.returnValue(of());
