...
describe('CriarEntregasComponent', () => {
    ...
    let service = jasmine.createSpyObj('CriarEntregasServico', ['criarEntrega']);
    ...
    it('deve avisar sucesso', () => {
      ...
      service.criarEntrega.and.returnValue(of(entrega));
  ...
  it('se não houver resposta não deve atualizar', () => {
      ...
      service.criarEntrega.and.returnValue(of());
