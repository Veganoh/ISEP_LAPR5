...
describe('CriarCamioesComponent', () => {
    ...
    let service = jasmine.createSpyObj('CriarCamioesService', ['criarCamiao']);;
    ...
    it('deve conseguir criar um armazem com sucesso', () => {
        ...
        service.criarCamiao.and.returnValue(of(camiaoDto));
    ...
    it('se não haver resposta não deve atualizar', () => {
        ...
        service.criarCamiao.and.returnValue(of());
