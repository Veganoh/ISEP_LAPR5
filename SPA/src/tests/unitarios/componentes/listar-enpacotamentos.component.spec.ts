...
describe('CriarArmazensComponente', () => {
    ...
    let listarService = jasmine.createSpyObj('ListarEnpacotamentosService', ['obterEnpacotamentosPagina']);
    ...
    it('deve conseguir criar um armazem com sucesso', () => {
        listarService.obterEnpacotamentosPagina.and.returnValue(of({
            count: 3,
