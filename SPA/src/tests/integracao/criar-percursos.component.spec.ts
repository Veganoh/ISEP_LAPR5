...
describe('CriarEntregasComponent', () => {
    ...
    let armazem_service: ListarArmazensServico;
    ...
    let httpArmazemSpy:any = jasmine.createSpyObj('HttpClient', ['get']);
    ...
    beforeEach(() => {
        ...
        armazem_service = new ListarArmazensServico(httpArmazemSpy);

        httpArmazemSpy.get.and.returnValue(of(armazemLista));
